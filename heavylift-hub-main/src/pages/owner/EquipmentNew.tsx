...
const OwnerEquipmentNew = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast({ title: 'Equipment Listed!', description: 'Your equipment has been added successfully.' });
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">List your equipment for rent</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end gap-4">
          ...
          <Button type="submit" disabled={isSubmitting} className="gap-2">
            <Save className="h-4 w-4" /> {isSubmitting ? 'Saving...' : 'Save & Submit'}
          </Button>
        </div>
      </form>
    </div>
...
export default OwnerEquipmentNew;